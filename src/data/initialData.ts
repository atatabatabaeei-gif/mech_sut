...
export const INITIAL_FACULTY: FacultyMember[] = [
  {
    ...
    title: 'دانشیار',
    field: 'مکانیک سیالات و سیستم‌های میکرو/نانو',
    shortDesc: 'متخصص سیستم‌های میکرو و نانو، مایکروفابریکیشن و دینامیک سیالات در مقیاس میکرو.',
    bio: 'دکتر حسین پاکزاد فارغ‌التحصیل دکتری مهندسی مکانیک از دانشگاه EPFL سوییس و عضو هیئت علمی گروه سیالات دانشکده مهندسی مکانیک دانشگاه صنعتی شریف است. ایشان در حوزه مایکرو و نانوسیالات، مایکروفابریکیشن و سیستم‌های میکرو-الکترومکانیکی (MEMS) فعالیت تحقیقاتی گسترده‌ای دارند.',
  ...
  },
  {
    ...
    title: 'استاد تمام',
    field: 'جامدات، ساخت پیشرفته و مواد مرکب',
    shortDesc: 'متخصص فرآیندهای ساخت پیشرفته، ماشینکاری التراسونیک و طراحی ماشین‌آلات CNC صنعتی.',
    bio: 'دکتر کیوان محمدی دارای دکتری مهندسی مکانیک از دانشگاه صنعتی شریف و از استادان باسابقه گروه جامدات دانشکده است. زمینه تحقیقاتی اصلی وی فرآیندهای ساخت نوآورانه، ماشینکاری مواد نوین به کمک امواج اولتراسونیک و طراحی و اتوماسیون ماشین‌های ابزار CNC می‌باشد.',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&q=80&w=400',
    email: 'kaivan.mohammadi@sharif.edu',
    phone: '۰۲۱-۶۶۱۶۵۵۸۵',
    office: 'دانشکده مکانیک — طبقه ۶ — اتاق ۶۱۹',
    scholarUrl: 'https://scholar.google.com',
    skills: ['ماشینکاری التراسونیک', 'طراحی ماشین ابزار CNC', 'مواد مرکب (کامپوزیت)', 'فرآیندهای ساخت پیشرفته', 'طراحی صنعتی'],
    supervisedLabs: ['l3'],
    projectsLed: ['p6'],
    publications: [
  ...
  },
  {
    ...
    title: 'دانشیار',
    field: 'مهندسی دریا و هیدرودینامیک',
    shortDesc: 'پژوهشگر ارشد هیدرودینامیک کاربردی، هوش مصنوعی در مهندسی دریا و انرژی‌های تجدیدپذیر دریایی.',
    bio: 'دکتر مریم کامران دارای دکتری مهندسی مکانیک از دانشگاه علم و صنعت ایران و عضو هیئت علمی گروه مهندسی دریا دانشکده مهندسی مکانیک دانشگاه شریف است. تمرکز پژوهشی ایشان بر روی مکانیک سیالات عددی و تجربی در دریا، سیستم‌های انرژی دریایی و کاربرد الگوریتم‌های هوش مصنوعی و یادگیری ماشین در مهندسی سواحل و فراساحل است.',
    avatarUrl: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=400',
    email: 'kamran@sharif.edu',
    phone: '۰۲۱-۶۶۱۶۵۵۳۳',
    office: 'دانشکده مکانیک — طبقه ۴ — اتاق ۴۰۸',
    scholarUrl: 'https://scholar.google.com',
    skills: ['هیدرودینامیک کاربردی', 'مکانیک سیالات عددی و تجربی', 'انرژی‌های تجدیدپذیر دریایی', 'هوش مصنوعی در مهندسی دریا', 'طراحی سازه‌های دریایی'],
    supervisedLabs: [],
    projectsLed: ['p4'],
    publications: [
  ...
  },
  {
    ...
    title: 'دانشیار',
    field: 'دینامیک، کنترل و سیستم‌های خودران',
    shortDesc: 'متخصص سیستم‌های خودران، الگوریتم‌های هوشمند عیب‌یابی و کنترل پیشرفته رباتیک.',
    bio: 'دکتر سمیه محمدی دارای دکتری مهندسی مکانیک از دانشگاه صنعتی شریف و عضو هیئت علمی گروه کنترل دانشکده مکانیک است. حوزه‌های کاری ایشان شامل پایش سلامت آنلاین، الگوریتم‌های عیب‌یابی هوشمند، طراحی سیستم‌های خودران و کنترل پیشرفته سیستم‌های غیرخطی می‌باشد.',
  ...
  },
  {
    ...
    title: 'دانشیار',
    field: 'کنترل، رباتیک اجتماعی و شناختی',
    shortDesc: 'پژوهشگر برجسته رباتیک اجتماعی و شناختی، طراحی ربات‌های تعاملی و هوش مصنوعی شناختی.',
    bio: 'دکتر علیرضا طاهری فارغ‌التحصیل دکتری مهندسی مکانیک از دانشگاه صنعتی شریف و مدیر آزمایشگاه رباتیک اجتماعی و شناختی دانشکده است. ایشان در حوزه طراحی ربات‌های توانبخشی، ربات‌های اجتماعی آموزش و درمان، تعامل انسان و ربات (HRI) و هوش مصنوعی شناختی از اساتید مطرح کشور می‌باشند.',
  ...
  },
  {
    ...
    title: 'دانشیار',
    field: 'سیالات، انتقال حرارت و لوله‌های حرارتی',
    shortDesc: 'متخصص سیستم‌های انتقال حرارت، لوله‌های حرارتی پیشرفته و کاربرد هوش مصنوعی در مکانیک سیالات.',
    bio: 'دکتر محمدعلی بیجارچی فارغ‌التحصیل دکتری مهندسی مکانیک از دانشگاه صنعتی شریف و سرپرست آزمایشگاه لوله‌های حرارتی دانشکده مهندسی مکانیک است. زمینه تحقیقاتی ایشان شامل انتقال حرارت پیشرفته، خنک‌کاری تجهیزات الکترونیکی پرقدرت، انتقال جرم زیستی و بکارگیری الگوریتم‌های هوش مصنوعی در مسائل حرارت و سیالات می‌باشد.',
  ...
  },
  {
    ...
    title: 'استاد تمام',
    field: 'کنترل، دینامیک خودرو و بهینه‌سازی',
    shortDesc: 'استاد برجسته دینامیک خودرو، طراحی شاسی و بهینه‌سازی سیستم‌های دینامیکی چندجسمی.',
    bio: 'دکتر محمود سعادت فومنی فارغ‌التحصیل دکتری مهندسی مکانیک از دانشگاه صنعتی شریف و استاد برجسته گروه کنترل و دینامیک دانشکده است. ایشان سال‌ها در زمینه طراحی شاسی، بهینه‌سازی سیستم‌های تعلیق و فرمان، دینامیک خودرو و سیستم‌های کنترل مکانیکی مجری پروژه‌های صنعتی متعدد خودروسازی بوده‌اند.',
  ...
  },
  {
    ...
    title: 'استاد تمام',
    field: 'کنترل، پایش وضعیت و آنالیز ارتعاشات',
    shortDesc: 'مرجع تخصصی پایش وضعیت تجهیزات دوار، آنالیز ارتعاشات صنعتی و روتوردینامیک در کشور.',
    bio: 'دکتر مهدی بهزاد دارای دکتری مهندسی مکانیک از دانشگاه نیوساوث ولز (UNSW) استرالیا و استاد تمام برجسته دانشگاه صنعتی شریف است. ایشان موسس و سرپرست آزمایشگاه پایش وضعیت و ارتعاشات صنعتی شریف، رئیس انجمن پایش وضعیت ایران و بنیان‌گذار روش‌های نوین عیب‌یابی یاتاقان‌ها و توربوماشین‌های صنایع نفت و نیروگاهی کشور می‌باشند.',
  ...
  },
  {
    ...
    title: 'دانشیار',
    field: 'سیالات و تهویه صنعتی پیشرفته',
    shortDesc: 'متخصص سیستم‌های تهویه مطبوع صنعتی، تهویه متمایز و مدیریت مصرف انرژی در سالن‌های صنعتی.',
    bio: 'دکتر مجتبی تقی پور فارغ‌التحصیل دکتری مهندسی مکانیک از دانشگاه صنعتی شریف و سرپرست آزمایشگاه سیستم‌های پیشرفته تهویه صنعتی است. فعالیت‌های علمی ایشان شامل بررسی فیزیک توربولانس جریان‌های برشی، کاهش مصرف انرژی در سیستم‌های تهویه مطبوع صنعتی، تهویه متمایز بیمارستانی و صنعتی و مدلسازی جریان‌های محبوس می‌باشد.',
  ...
  },
  {
    ...
    title: 'دانشیار',
    field: 'سیالات، توربوماشین‌ها و روش‌های عددی',
    shortDesc: 'متخصص تحلیل توربوماشین‌ها، تحلیل داده‌های جریان، بهینه‌سازی استوار و روش‌های محاسباتی سیالات.',
    bio: 'دکتر محمدصادق کریمی فارغ‌التحصیل دکتری مشترک مهندسی مکانیک از دانشگاه تهران و دانشگاه بروکسل بلژیک و عضو هیئت علمی گروه مکانیک سیالات دانشگاه صنعتی شریف است. پژوهش‌های وی بر روی تحلیل توربوماشین‌ها، آنالیز داده‌های محاسباتی سیالات، روش‌های بهینه‌سازی استوار و سیستم‌های BioMEMS متمرکز است.',
